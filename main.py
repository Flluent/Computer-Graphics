...
# Конвертация BGR в RGB для правильного отображения цветов
...
# Вычисление разницы между полутоновыми изображениями
...
# Отображение серого изображения (метод 1)
...
# Отображение серого изображения (метод 2)
...
# Отображение разницы
axes[2, 1].imshow(difference_image, cmap='hot')
...
# Закрытие всех окон OpenCV (теперь не нужны, так как используем matplotlib)
